...
parser.add_argument('--face', type=str, default="Video/VID.jpg", 
					help='Filepath of video/image that contains faces to use', required=False)
parser.add_argument('--audio', type=str, default="C:/_GIT/full-projects-3-five-guys/Real-Time-Voice-Cloning-master/results/AUD.wav", 
					help='Filepath of video/audio file to use as raw audio source', required=False)
parser.add_argument('--outfile', type=str, help='Video path to save result. See default for an e.g.', 
								default=f'results/randomname.mp4')
