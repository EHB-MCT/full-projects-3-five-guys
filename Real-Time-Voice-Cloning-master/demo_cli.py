...
if __name__ == '__main__':
    ...
    parser.add_argument('--audio', type=str, default="C:/_GIT/full-projects-3-five-guys/Real-Time-Voice-Cloning-master/input/AUD.wav", required=False)

    parser.add_argument('--text', type=str, default="Hello , my name is Albert Einstein and i was on the polar express.", required=False)
    ...
    while True:
        try:
            ...
            message = "Reference voice: enter an audio filepath of a voice to be cloned (mp3, " \
                      "wav, m4a, flac, ...):\n"
            in_fpath = Path((args.audio).replace("\"", "").replace("\'", ""))
            ...
            # Save it on the disk
            filename = "C:/_GIT/full-projects-3-five-guys/Real-Time-Voice-Cloning-master/results/AUD.wav"
